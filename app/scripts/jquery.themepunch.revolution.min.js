...
(function (e, t) {
	...
	function L(n, r) {
		...
		u.addClass("active").siblings("li").removeClass("active");
		...
		n.find(".tp-caption").each(function (n) {
			...
			if (c == 0) {
				...
				if (l.find("img").length > 0) {
					/*var m=l.find("img");if(m.data("ww")==t)m.data("ww",m.width());if(m.data("hh")==t)m.data("hh",m.height());var g=m.data("ww");var y=m.data("hh");m.width(g*r.bw);m.height(y*r.bh);d=m.width();v=m.height()*/
				} else {
					if (l.find("iframe").length > 0 || l.find("video").length > 0) {
						var b = false;
						var m = l.find("iframe");
...
(function (e) {
	...
	a = function (e, t, n, r) {
		var i;
		return (n = n || o(e, null)) ? (e = n.getPropertyValue(t.replace(u, "-$1").toLowerCase()), i = e || n.length ? e : n[t]) : e.currentStyle && (n = e.currentStyle, i = n[t]),
		r ? i : parseInt(i, 10) || 0
	},
	f = function (e) {
